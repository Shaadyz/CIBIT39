...
?>
    ...
    <main class="website-workarea">
        <section class="banner banner_before1" style="background-image: url('/local/templates/inner/assets/images/banner_blog.jpg');">
        ...
        <section class="container">
            <div class="blog-list">
                <a href="/local/templates/inner/blog-details.html" class="blog">
                    <div class="blog__img">
                        <img width="100%" height="100%" src="/local/templates/inner/assets/images/test_blog-img1.jpg" alt="">
                    </div>
                ...
                </a> <a href="/local/templates/inner/blog-details.html" class="blog">
                    <div class="blog__img">
                        <img width="100%" height="100%" src="/local/templates/inner/assets/images/test_blog-img2.jpg" alt="">
                    </div>
                    <div class="blog__desc">
                        <div class="blog__title">
                    ...
                    <div class="blog__img">
                        <img width="100%" height="100%" src="/local/templates/inner/assets/images/test_blog-img3.jpg" alt="">
                    </div>
                    <div class="blog__desc">
                        <div class="blog__title">
                            Что такое продакш-студия и для чего она нужна?
                    ...
                    <div class="blog__img">
                        <img width="100%" height="100%" src="/local/templates/inner/assets/images/test_blog-img4.jpg" alt="">
                    </div>
                    <div class="blog__desc">
                        <div class="blog__title">
                            Личный бренд и что такое продакш- студия
